...
export function IsAaForMePage() {
  ...
  return (
    <Section color='white' className='gap-6'>
      ...
      <div className='flex flex-col gap-4'>
        <Typography variant='body'>
          Вы ответили ДА на четыре или более вопросов? Если так, то вы, вероятно, попали в
          беду. Почему мы так считаем? Потому что об этом говорили тысячи людей в АА в
          течение многих лет.
        </Typography>
        <Typography variant='body'>
          И все же только ВЫ можете решить, нужно ли вам АА. Попытайтесь подойти к этому
          непредвзято. Если вы скажете ДА, мы будем рады показать вам, как мы сами бросили
          пить. Просто приходите.
        </Typography>
        <Typography variant='body'>
          АА не обещает решить все ваши жизненные проблемы. Но мы можем показать вам, как
          мы научились жить без выпивки «по одному дню».
        </Typography>
      </div>
      <LinkComponent
        icon='telegram'
