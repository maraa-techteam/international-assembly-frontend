...
export const PAGE_SEO: Record<string, PageSeo> = {
  ...
  '/privacy': {
    ...
    description:
      'Какие данные сайт Международной Ассамблеи русскоязычных АА получает через формы, зачем они нужны, кому передаются и как их удалить. Cookie не используются.',
  },
  '/services': {
